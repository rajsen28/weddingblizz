<html> 
   ...
   <body>
       <%@include file="decoretop.jsp" %>
       
               <div  class="divtheme">
            <div  class='innerdivtheme'>
                                   <br>                                   <br>

    <form action="decorecode.jsp">
        <table  align='center' border='0' cellspacing='10' cellpadding='5'  class='citytheme'>
            ...
            <tr>
                <td>CONTACT</td>
                <td><input type='number' name='dCont' class='texttheme'></td>
            </tr> 
            
             </tr>
            <tr>
                <td>MAIL ID</td>
                <td><input type='mail' name='dMail' class='texttheme'></td>
            </tr> 
