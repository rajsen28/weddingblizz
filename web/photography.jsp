    ...
    <form action="photographycode.jsp">
        <table  align='center' border='0' cellspacing='10' cellpadding='5'  class='citytheme'>
            ...
            <tr>
                ...
                <td><input type='text' name='pId' class='texttheme'></td>
            ...
            <tr>
                <td>CONTACT</td>
                <td><input type='number' name='pCont' class='texttheme'></td>
            </tr> 
            
             
            <tr>
                <td>MAIL ID</td>
                <td><input type='mail' name='pMail' class='texttheme'></td>
            </tr> 
